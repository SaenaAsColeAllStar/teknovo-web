...
function StoreCtaButton({ href, caption, label, icon }: StoreCtaButtonProps): ReactElement {
  return (
    <PublicSiteLink
      href={href}
      className={cn(
        "inline-flex h-14 min-w-0 shrink-0 items-center gap-3 rounded-none bg-brand px-4 text-white",
        "transition hover:bg-brand-strong focus-visible:outline-none focus-visible:ring-2",
...
export function FinalCtaSection(): ReactElement {
  return (
    <section className="bg-surface py-14 sm:py-16" aria-labelledby="cta-final-heading">
