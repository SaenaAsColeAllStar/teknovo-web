...
import { LOCAL_SEO_SCHOOL, SEO_PRIMARY_LANGUAGE, SEO_PRIMARY_LOCALE } from "@/lib/seo/school";
import { buildLandingAbsoluteUrl, resolveOgImageUrl, truncateMetaDescription } from "@/lib/seo/urls";

export { LOCAL_SEO_SCHOOL } from "@/lib/seo/school";
...
export const LOCAL_SEO_PAGES: Record<LocalSeoPageId, LocalSeoPageConfig> = {
  home: {
    ...
    internalLinks: [],
    sitemapPriority: 1,
    ogImage: LANDING_MEDIA.hero.bg01Webp,
  },
  "smk-pamanukan": {
  ...
  "ppdb-smk-pamanukan": {
    ...
    sitemapPriority: 0.95,
    ogImage: LANDING_MEDIA.ppdb.heroWebp,
  },
  "lms-smk-subang": {
    ...
    sitemapPriority: 0.95,
    ogImage: LANDING_MEDIA.fasilitas.lmsWebp,
  },
  "lms-smk-jawa-barat": {
...
export function resolveLocalSeoOgImageUrl(imagePath?: string): string {
  return resolveOgImageUrl(imagePath, LANDING_MEDIA.hero.bg01Webp);
}
